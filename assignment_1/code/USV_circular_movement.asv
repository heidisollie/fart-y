...
figure(figure_num); 
plot(p_n_b(:,2), p_n_b(:,1)), xlabel('east [m]'),ylabel('north [m]'), title('Plot of vehicle position'), grid; axis equal;
...
figure_num = figure_num + 1;
figure(figure_num)
plot(p_n_b_c(:,2), p_n_b_c(:,1)), xlabel('east [m]'),ylabel('north [m]'), title('Plot of vehicle position'), hold on;
